...
### Работа №1
**Текст задания:** Создайте класс "Car" с атрибутами производитель и модель. Создайте объект этого класса. Напишите комментарии для кода, объясняющие его работу.
...
### Работа №2
**Текст задания:** Дополните код из первого задания, добавив в него атрибуты и методы класса, заставьте машину "поехать". Напишите комментарии для кода, объясняющие его работу.
...
### Работа №3
**Текст задания:** Создайте новый класс "ElectricCar" с методом "charge" и атрибутом емкость батареи. Реализуйте его наследование от класса Car. Напишите комментарии для кода, объясняющие его работу.
...
### Работа №4
**Текст задания:** Реализуйте инкапсуляцию для класса Car. Создайте защищенный атрибут производителя и приватный атрибут модели. Напишите комментарии для кода, объясняющие его работу.
...
### Работа №5
**Текст задания:** Реализуйте полиморфизм создав общий класс "Shape" и два класса "Rectangle" и "Circle" с методами для подсчета площади. Напишите комментарии для кода, объясняющие его работу.
...
**Текст задания:** Самостоятельно создайте класс и его объект. Они должны отличаться от тех, что указаны в теоретическом материале и лабораторных заданиях.
...
**Текст задания:** Самостоятельно создайте атрибуты и методы для ранее созданного класса.
...
**Текст задания:** Самостоятельно реализуйте наследование, продолжая работать с ранее созданным классом.
...
**Текст задания:** Самостоятельно реализуйте инкапсуляцию, продолжая работать с ранее созданным классом.
...
**Текст задания:** Самостоятельно реализуйте полиморфизм.
